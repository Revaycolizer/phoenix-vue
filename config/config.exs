...
config :my_phoenix, MyPhoenixWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: MyPhoenixWeb.ErrorHTML, json: MyPhoenixWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: MyPhoenix.PubSub,
  live_view: [signing_salt: "LOaLAoMd"]
...
config :my_phoenix, MyPhoenix.Mailer, adapter: Swoosh.Adapters.Local
